...
Also on **Thursday (5th)**, we have our regularly scheduled **WMS Talk** titled *On the Embeddedness of Minimal Surfaces*, with student speaker Aris Mercier (one of our Academic Support Officers), in **MS.04**, starting at **1800**. Note that there will be no pizza for the talk this week. Instead, pizza will be available at Integrating Factor (see below).
